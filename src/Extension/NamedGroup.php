...
enum NamedGroup: int implements Itemable, Labelable, Selectable
{
    ...
    public function getLabel(): string
    {
        return match ($this) {
            self::RESERVED => '保留',
            self::SECP256R1 => 'secp256r1 椭圆曲线',
            self::SECP384R1 => 'secp384r1 椭圆曲线',
            self::SECP521R1 => 'secp521r1 椭圆曲线',
            self::X25519 => 'X25519 椭圆曲线',
            self::X448 => 'X448 椭圆曲线',
            self::FFDHE2048 => 'FFDHE2048 有限域',
            self::FFDHE3072 => 'FFDHE3072 有限域',
            self::FFDHE4096 => 'FFDHE4096 有限域',
            self::FFDHE6144 => 'FFDHE6144 有限域',
            self::FFDHE8192 => 'FFDHE8192 有限域',
        };
    }
